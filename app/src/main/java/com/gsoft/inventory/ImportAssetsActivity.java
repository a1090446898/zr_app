...
import com.gsoft.inventory.adapter.BluetoothListAdapter;
...
public class ImportAssetsActivity extends BaseCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import_assets);
        initializeView();
    }
    ...
    QMUITopBar topBar;
    CheckBox chkZengLiang, chkAll;

    @Override
    public void initializeView() {
        topBar = (QMUITopBar) findViewById(R.id.topbar);
        topBar.setTitle("导入资产清单");
        ...
        chkZengLiang = findViewById(R.id.chkZengLiang);
    ...
    private class ImportAssetsTask extends AsyncTask<String, Void, String> {
        ...
        boolean zeingliang = false;

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            zeingliang = chkZengLiang.isChecked();
            DataTransmitHelper.clearAssets();
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                result =  DataTransmitHelper.importAssets(filePath, zeingliang);
                return result;
            }catch (Exception e){
                e.printStackTrace();
                Log.e("ImportAssets", "导入文件失败：" + e.getMessage());
            }
