...
public class ImportPrintersActivity extends BaseCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import_printers);
        initializeView();
    }
    ...
    public void initializeView() {
        ...
        bt_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                new ImportPrinterTask().execute(fileArrayList.get(i).getPath());
            }
        });
    }
    ...
    private class ImportPrinterTask extends AsyncTask<String, Void, String> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            DataTransmitHelper.clearPrinters();
        ...
        protected String doInBackground(String... params) {
            ...
            return DataTransmitHelper.importPrinters(filePath);
        }
