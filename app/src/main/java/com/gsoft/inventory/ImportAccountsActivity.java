...
public class ImportAccountsActivity extends BaseCompatActivity {
    ...
    private class ImportAssetsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            DataTransmitHelper.clearAccounts();
        ...
        protected String doInBackground(String... params) {
            ...
            return DataTransmitHelper.importAccounts(filePath);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (TextUtils.isEmpty(s)) {
                ...
                List<Accounts> qcys = Accounts.find(Accounts.class, "YHXM LIKE '%清查员%'");
                if (qcys.size() > 0) ZCQCY.deleteAll(ZCQCY.class);
                for (Accounts account : qcys) {
                    ZCQCY zcqcy = new ZCQCY();
                    zcqcy.CODE = account.getYHBH();
                    zcqcy.NAME = account.getYHXM();
                    zcqcy.save();
                }
            } else {
                showShortText(s);
