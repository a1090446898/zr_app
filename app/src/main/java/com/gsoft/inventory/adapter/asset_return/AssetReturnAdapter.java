package com.gsoft.inventory.adapter.asset_return;
 ...
 * @author 10904
 */
public class AssetReturnAdapter extends RecyclerView.Adapter<AssetReturnAdapter.ViewHolder> {

    private List<AssetReturn> dataList = new ArrayList<>();

    public AssetReturnAdapter(List<AssetReturn> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_asset_return_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AssetReturn item = dataList.get(position);
    ...
    public void removeSelected() {
        List<AssetReturn> toRemove = new ArrayList<>();
        for (AssetReturn item : dataList) {
