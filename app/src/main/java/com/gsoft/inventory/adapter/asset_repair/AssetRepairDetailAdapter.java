 ...
 * @author 10904
 */
public class AssetRepairDetailAdapter extends RecyclerView.Adapter<AssetRepairDetailAdapter.ViewHolder> {

    private List<AssetRepairDetailItem> dataList = new ArrayList<>();

    public AssetRepairDetailAdapter(List<AssetRepairDetailItem> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_asset_repair_detail_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AssetRepairDetailItem item = dataList.get(position);
    ...
    public void selectAll(boolean isSelect) {
        for (AssetRepairDetailItem item : dataList) {
    ...
    public void removeSelected() {
        List<AssetRepairDetailItem> toRemove = new ArrayList<>();
        for (AssetRepairDetailItem item : dataList) {
