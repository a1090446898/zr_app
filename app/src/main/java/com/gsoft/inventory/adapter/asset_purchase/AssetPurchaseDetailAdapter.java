 ...
 * @author 10904
 */
public class AssetPurchaseDetailAdapter extends RecyclerView.Adapter<AssetPurchaseDetailAdapter.ViewHolder> {

    private List<AssetPurchaseDetailItem> dataList = new ArrayList<>();

    public AssetPurchaseDetailAdapter(List<AssetPurchaseDetailItem> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_asset_purchase_detail_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AssetPurchaseDetailItem item = dataList.get(position);
    ...
    public void selectAll(boolean isSelect) {
        for (AssetPurchaseDetailItem item : dataList) {
    ...
    public void removeSelected() {
        List<AssetPurchaseDetailItem> toRemove = new ArrayList<>();
        for (AssetPurchaseDetailItem item : dataList) {
