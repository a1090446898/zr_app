 ...
 * @author 10904
 */
public class AssetTransferDetailAdapter extends RecyclerView.Adapter<AssetTransferDetailAdapter.ViewHolder> {

    private List<AssetTransferDetailItem> dataList = new ArrayList<>();

    public AssetTransferDetailAdapter(List<AssetTransferDetailItem> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_asset_transfer_detail_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AssetTransferDetailItem item = dataList.get(position);
    ...
    public void selectAll(boolean isSelect) {
        for (AssetTransferDetailItem item : dataList) {
    ...
    public void removeSelected() {
        List<AssetTransferDetailItem> toRemove = new ArrayList<>();
        for (AssetTransferDetailItem item : dataList) {
