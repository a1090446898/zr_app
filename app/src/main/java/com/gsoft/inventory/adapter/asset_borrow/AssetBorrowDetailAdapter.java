 ...
 * @author 10904
 */
public class AssetBorrowDetailAdapter extends RecyclerView.Adapter<AssetBorrowDetailAdapter.ViewHolder> {

    private List<AssetBorrowDetailItem> dataList = new ArrayList<>();

    public AssetBorrowDetailAdapter(List<AssetBorrowDetailItem> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_asset_borrow_detail_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AssetBorrowDetailItem item = dataList.get(position);
    ...
    public void selectAll(boolean isSelect) {
        for (AssetBorrowDetailItem item : dataList) {
    ...
    public void removeSelected() {
        List<AssetBorrowDetailItem> toRemove = new ArrayList<>();
        for (AssetBorrowDetailItem item : dataList) {
