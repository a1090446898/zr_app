...
public class ImportQCYActivity extends BaseCompatActivity {

    private static final int FILE_SELECT_CODE = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_import_qcyactivity);
        initializeView();
    }
    ...
    public void initializeView() {
        ...
        bt_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                new ImportAssetQCYTask().execute(fileArrayList.get(i).getPath());
            }
        });
    }
    ...
    private class ImportAssetQCYTask extends AsyncTask<String, Void, String> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            DataTransmitHelper.clearQCY();
        ...
        protected String doInBackground(String... params) {
            ...
            return DataTransmitHelper.importAssetQCY(filePath);
        }
