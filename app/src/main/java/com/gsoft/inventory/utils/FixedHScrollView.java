 ...
 * */
public class FixedHScrollView extends HorizontalScrollView {
	ScrollViewObserver mScrollViewObserver = new ScrollViewObserver();

	public FixedHScrollView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
	}

	public FixedHScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public FixedHScrollView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Log.d("ScrollDebug", "Touch event received: " + ev.getAction());
