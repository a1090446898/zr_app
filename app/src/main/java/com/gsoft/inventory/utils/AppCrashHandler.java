...
public class AppCrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private MyActivityLifecycleCallbacks lifecycleCallbacks;
        ...
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            try {
                if (lifecycleCallbacks != null) {
                    lifecycleCallbacks.removeAllActivities();
                }
                Thread.sleep(3000);
     ...
     * @param context
     */
    public void init(Context context, MyActivityLifecycleCallbacks lifecycleCallbacks) {
        mContext = context;
    ...
    public static AppCrashHandler instance() {
        if (crashHandler == null) {
            crashHandler = new AppCrashHandler();
        }
        return crashHandler;
    }
}
